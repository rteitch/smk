        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="row pl-3 pt-3 pb-4 pr-3 text-center">
                    <div class="col">
                        <a class="btn btn-block btn-info text-white btn-sm" href="{{ route('users.edit', [$user->id]) }}">Edit</a>
                    </div>
                    <div class="col">
                        <a class="btn btn-block btn-primary text-white btn-sm" href="{{ route('users.edit', [$user->id]) }}">Ubah Password</a>
                    </div>
                </div>
                <div>
